...
function AdministrativeBoardForm({ onSubmit, onCancel, defaultValue }) {
  const {
    register,
    handleSubmit,
    formState: { errors = {} },
...
export default AdministrativeBoardForm;
